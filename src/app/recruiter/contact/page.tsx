...
export default function RecruiterContactPage() {
  ...
  return (
    <SubPageLayout title="" backHref="/recruiter" backLabel="Rekrutterer">
          ...
          <div className="flex flex-col gap-8 pt-0 lg:pt-4 text-center lg:text-left">
            ...
            >
              <div
                ...
                style={{ background: "var(--surface-2)", border: "1px solid var(--border)", maxWidth: "fit-content" }}
              >
              ...
              <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                <motion.a
                  ...
                  style={{ background: "var(--accent)", color: "#fff", fontFamily: "var(--font-body)", boxShadow: "0 4px 24px rgba(37,99,235,0.35)" }}
                >
                  <Mail size={15} />
                  Send mail
                </motion.a>
